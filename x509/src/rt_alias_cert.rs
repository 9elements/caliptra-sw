...
mod tests {
    ...
    fn test_cert_signing() {
        ...
        let params = RtAliasCertTbsParams {
            ...
            tcb_info_Rt_tci: &[0xEFu8; RtAliasCertTbsParams::TCB_INFO_FMC_TCI_LEN],
        };
        ...
        assert_eq!(
            &cert.tbs()[RtAliasCertTbs::TCB_INFO_FMC_TCI_OFFSET
                ..RtAliasCertTbs::TCB_INFO_FMC_TCI_OFFSET + RtAliasCertTbs::TCB_INFO_FMC_TCI_LEN],
